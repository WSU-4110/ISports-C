...
import com.First.ISportsC.UserClient;
import com.First.ISportsC.adapters.ChatMessageRecyclerAdapter;
import com.First.ISportsC.models.ChatMessage;
        ...
        View.OnClickListener
{
    ...
    private void getIncomingIntent(){
        if(getIntent().hasExtra(getString(R.string.intent_chatroom))){
            mGame = getIntent().getParcelableExtra(getString(R.string.intent_chatroom));
            setChatroomName();
            joinChatroom();
        }
    }
